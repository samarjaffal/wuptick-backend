    ...
    Project: {
        ...
        members: async ({ members }) => {
            ...
            try {
                ...
                user = mongoHelper.FindObjectDataFromArrayWithID(usersData, members, 'user', '_id');
                role = mongoHelper.FindObjectDataFromArrayWithID(rolesData, members, 'role', '_id' );
                team = mongoHelper.FindObjectDataFromArrayWithID(teamsData, members, 'team', '_id');
