...
module.exports = {
    ...
    removeProject: async (root, { userId, projectId }) => {
        let user, project;
        ...
        try {
            ...
            const operatorUser = {
                projects: { project: ObjectID(projectId) },
            };

            await mongoDB.removeFromSet(collection, userId, operatorUser);
            await mongoDB.removeFromSet('projects', projectId, operatorProject);
